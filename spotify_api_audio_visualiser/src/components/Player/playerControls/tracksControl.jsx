      ...
      <div className="controls-wrapper">
        <div className="track-control">
          ...
          <div className="volume-control">
            <button onClick={() => setMuteVolume((prev) => !prev)} className="control-button">
              {muteVolume || volume < 5 ? (
                <IoMdVolumeOff />
              ) : volume < 40 ? (
                <IoMdVolumeLow />
            ...
            <input
              ...
              style={{
                background: `linear-gradient(to right, #e91e63 0%, #e91e63 ${volume}%, #333 ${volume}%, #333 100%)`
              }}
            />
          </div>
          <div className='repeat-suffle'>
            <button onClick={shuffleTracks} className={`control-button ${shuffleActive ? 'active' : ''}`}>
              <IoShuffle />
            </button>
            <button onClick={handleRepeatMode} className={`control-button ${repeatMode !== 'no-repeat' ? 'active' : ''}`}>
              {repeatMode === 'no-repeat' && <IoRepeat />}
